...
public class CaseUtils {
	...
	public static String getRealFilePath(PdfDTO file) throws ParseException {
		...
		String dateMigratedData =  CacheManager.Parameters().findParamValueAsString(ParametersName.MFS_DATE_MIGRATED_DATA);
		String pathMigratedData = CacheManager.Parameters().findParamValueAsString(ParametersName.MFS_PATH_MIGRATED_DATA);
