 ...
 * 
 */
@Entity(name = "ArchMessageLog")
@Table(name = "ARCH_MESSAGE_LOG", uniqueConstraints = { @UniqueConstraint(columnNames = { "ID" }) })
@NamedQueries({ @NamedQuery(name = "ArchMessageLog.findAll", query = "SELECT m FROM ArchMessageLog m"), })
public class ArchMessageLog implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@Basic(optional = false)
	@GenericGenerator(name = "seq_msgLog", strategy = "com.mcredit.data.common.entity.SequenceGenerate", parameters = @Parameter(name = "seqName", value = "SEQ_ARCH_MESSAGE_LOG_ID.NEXTVAL"))
	...
	public ArchMessageLog() {
	}

	public ArchMessageLog(String fromChannel, Integer msgOrder, String msgRequest, String msgStatus, String msgType,
	...
	public ArchMessageLog(String fromChannel, String msgRequest, String msgResponse, Timestamp processTime, String relationId, String responseCode, Timestamp responseTime, String toChannel, Long transId,
			String transType) {
		super();
		this.fromChannel = fromChannel;
		this.msgRequest = msgRequest;
