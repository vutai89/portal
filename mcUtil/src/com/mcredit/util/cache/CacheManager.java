package com.mcredit.util.cache;
/**
* Title:        Caching
* Description:
...
public class CacheManager {
  ...
  private static Object lockCacheManagerObject = new Object();
...
continuously */
  ...
  {
	  synchronized (lockCacheManagerObject) {
  ...
  public static void remove(Object identifier)
  {
	  synchronized (lockCacheManagerObject) {
